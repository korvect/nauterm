...
typedef _CreateLocalSessionConfiguredNative = Uint64 Function(
  Uint32 columns,
  Uint32 rows,
...
typedef _CreateLocalSessionConfiguredDart = int Function(
  int columns,
  int rows,
  int emulatorBackend,
  int scrollbackLines,
...
typedef _CreateCommandSessionConfiguredNative = Uint64 Function(
  Uint32 columns,
  Uint32 rows,
  Uint32 emulatorBackend,
  Uint32 scrollbackLines,
...
typedef _CreateCommandSessionConfiguredDart = int Function(
  int columns,
  int rows,
  int emulatorBackend,
  int scrollbackLines,
...
typedef _CreateSshSessionConfiguredNative = Uint64 Function(
  Uint32 columns,
  Uint32 rows,
  Uint32 emulatorBackend,
  Uint32 scrollbackLines,
...
typedef _CreateSshSessionConfiguredDart = int Function(
  int columns,
  int rows,
  int emulatorBackend,
  int scrollbackLines,
...
typedef _CreateMoshSessionConfiguredNative = Uint64 Function(
  Uint32 columns,
  Uint32 rows,
  Uint32 emulatorBackend,
  Uint32 scrollbackLines,
...
typedef _CreateMoshSessionConfiguredDart = int Function(
  int columns,
  int rows,
  int emulatorBackend,
  int scrollbackLines,
...
typedef _ReconnectSshSessionNative = Bool Function(
  Uint64 sessionId,
  Pointer<Utf8> host,
  Uint16 port,
  Pointer<Utf8> username,
...
typedef _ReconnectSshSessionDart = bool Function(
  int sessionId,
  Pointer<Utf8> host,
  int port,
  Pointer<Utf8> username,
...
typedef _ReconnectMoshSessionNative = Bool Function(
  Uint64 sessionId,
  Pointer<Utf8> host,
  Uint16 port,
  Pointer<Utf8> username,
...
typedef _ReconnectMoshSessionDart = bool Function(
  int sessionId,
  Pointer<Utf8> host,
  int port,
  Pointer<Utf8> username,
...
typedef _CreateTelnetSessionConfiguredNative = Uint64 Function(
  Uint32 columns,
  Uint32 rows,
  Uint32 emulatorBackend,
  Uint32 scrollbackLines,
...
typedef _CreateTelnetSessionConfiguredDart = int Function(
  int columns,
  int rows,
  int emulatorBackend,
  int scrollbackLines,
...
typedef _CreateSerialSessionConfiguredNative = Uint64 Function(
  Uint32 columns,
  Uint32 rows,
  Uint32 emulatorBackend,
  Uint32 scrollbackLines,
...
typedef _CreateSerialSessionConfiguredDart = int Function(
  int columns,
  int rows,
  int emulatorBackend,
  int scrollbackLines,
...
typedef _CreateTerminalConfiguredNative = Pointer<Void> Function(
  Uint32 columns,
  Uint32 rows,
  Uint32 emulatorBackend,
  Uint32 scrollbackLines,
...
typedef _CreateTerminalConfiguredDart = Pointer<Void> Function(
  int columns,
  int rows,
  int emulatorBackend,
  int scrollbackLines,
...
typedef _CaptureRecoverNative = Pointer<Utf8> Function(
  Pointer<Utf8>,
  Pointer<Utf8>,
);
typedef _CaptureRecoverDart = Pointer<Utf8> Function(
  Pointer<Utf8>,
  Pointer<Utf8>,
);
...
typedef _ResizeSessionNative = Bool Function(
  Uint64 sessionId,
  Uint32 columns,
  Uint32 rows,
  Uint32 cellWidth,
...
typedef _ResizeSessionDart = bool Function(
  int sessionId,
  int columns,
  int rows,
  int cellWidth,
...
typedef _SearchSessionDart = Pointer<Utf8> Function(
  int sessionId,
  Pointer<Utf8> query,
  int direction,
  int originRow,
...
typedef _SelectionTextSessionNative = Pointer<Utf8> Function(
  Uint64 sessionId,
  Int64 start,
  Int64 end,
);
typedef _SelectionTextSessionDart = Pointer<Utf8> Function(
  int sessionId,
  int start,
  int end,
);

typedef _TerminalSelectionTextNative = Pointer<Utf8> Function(
  Pointer<Void> handle,
  Int64 start,
  Int64 end,
);
typedef _TerminalSelectionTextDart = Pointer<Utf8> Function(
  Pointer<Void> handle,
  int start,
  int end,
);
...
typedef _CommandBlockSessionDart = Pointer<Utf8> Function(
  int sessionId,
  int offset,
);

typedef _TerminalCommandBlockNative = Pointer<Utf8> Function(
  Pointer<Void> handle,
  Int64 offset,
);
typedef _TerminalCommandBlockDart = Pointer<Utf8> Function(
  Pointer<Void> handle,
  int offset,
);

typedef _PromptClickMoveSessionNative = Pointer<Utf8> Function(
  Uint64 sessionId,
  Int64 offset,
);
typedef _PromptClickMoveSessionDart = Pointer<Utf8> Function(
  int sessionId,
  int offset,
);

typedef _TerminalPromptClickMoveNative = Pointer<Utf8> Function(
  Pointer<Void> handle,
  Int64 offset,
);
typedef _TerminalPromptClickMoveDart = Pointer<Utf8> Function(
  Pointer<Void> handle,
  int offset,
);
...
typedef _SetWakeupNative = Bool Function(
  Uint64 sessionId,
  Pointer<NativeFunction<_WakeupNative>> callback,
  Pointer<Void> userData,
);
typedef _SetWakeupDart = bool Function(
  int sessionId,
  Pointer<NativeFunction<_WakeupNative>> callback,
  Pointer<Void> userData,
);
...
typedef _WriteCodepointNative = Bool Function(
  Uint64 sessionId,
  Uint32 codepoint,
);
typedef _WriteCodepointDart = bool Function(int sessionId, int codepoint);

typedef _WriteSessionBytesNative = Bool Function(
  Uint64 sessionId,
  Pointer<Uint8> bytes,
  IntPtr len,
);
typedef _WriteSessionBytesDart = bool Function(
  int sessionId,
  Pointer<Uint8> bytes,
  int len,
);

typedef _SendInputCodepointNative = Bool Function(
  Uint64 sessionId,
  Uint32 codepoint,
);
typedef _SendInputCodepointDart = bool Function(int sessionId, int codepoint);

typedef _SendInputBytesStatusNative = Uint32 Function(
  Uint64 sessionId,
  Pointer<Uint8> bytes,
  IntPtr len,
);
typedef _SendInputBytesStatusDart = int Function(
  int sessionId,
  Pointer<Uint8> bytes,
  int len,
);

typedef _SnapshotNative = Pointer<_NativeTerminalSnapshot> Function(
  Uint64 sessionId,
);
typedef _SnapshotDart = Pointer<_NativeTerminalSnapshot> Function(
  int sessionId,
);
...
typedef _TerminalResizeNative = Void Function(
  Pointer<Void> handle,
  Uint32 columns,
  Uint32 rows,
  Uint32 cellWidth,
...
typedef _TerminalResizeDart = void Function(
  Pointer<Void> handle,
  int columns,
  int rows,
  int cellWidth,
...
typedef _TerminalScrollLinesNative = Bool Function(
  Pointer<Void> handle,
  Int32 lines,
);
typedef _TerminalScrollLinesDart = bool Function(
  Pointer<Void> handle,
  int lines,
);
...
typedef _TerminalSearchNative = Pointer<Utf8> Function(
  Pointer<Void> handle,
  Pointer<Utf8> query,
  Uint32 direction,
  Uint32 originRow,
...
typedef _TerminalSearchDart = Pointer<Utf8> Function(
  Pointer<Void> handle,
  Pointer<Utf8> query,
  int direction,
  int originRow,
...
typedef _TerminalWriteCodepointNative = Bool Function(
  Pointer<Void> handle,
  Uint32 codepoint,
);
typedef _TerminalWriteCodepointDart = bool Function(
  Pointer<Void> handle,
  int codepoint,
);

typedef _TerminalWriteBytesNative = Bool Function(
  Pointer<Void> handle,
  Pointer<Uint8> bytes,
  IntPtr len,
);
typedef _TerminalWriteBytesDart = bool Function(
  Pointer<Void> handle,
  Pointer<Uint8> bytes,
  int len,
);

typedef _TerminalSnapshotNative = Pointer<_NativeTerminalSnapshot> Function(
  Pointer<Void> handle,
);
typedef _TerminalSnapshotDart = Pointer<_NativeTerminalSnapshot> Function(
  Pointer<Void> handle,
);
...
typedef _FreeSnapshotNative = Void Function(
  Pointer<_NativeTerminalSnapshot> snapshot,
);
typedef _FreeSnapshotDart = void Function(
  Pointer<_NativeTerminalSnapshot> snapshot,
);
...
typedef _ReadSessionShellHistoryNative = Pointer<Utf8> Function(
  Uint64 sessionId,
);
typedef _ReadSessionShellHistoryDart = Pointer<Utf8> Function(int sessionId);

typedef _SuppressOutputUntilNative = Bool Function(
  Uint64 sessionId,
  Pointer<Uint8> marker,
  IntPtr len,
);
typedef _SuppressOutputUntilDart = bool Function(
  int sessionId,
  Pointer<Uint8> marker,
  int len,
);
...
typedef _StartPortForwardNative = Pointer<Utf8> Function(
  Uint64 id,
...
typedef _StartPortForwardDart = Pointer<Utf8> Function(
  int id,
  Pointer<Utf8> forwardType,
  Pointer<Utf8> sshHost,
  int sshPort,
...
typedef _SshListDirectoriesNative = Pointer<Utf8> Function(
  Pointer<Utf8> host,
  Uint16 port,
  Pointer<Utf8> username,
  Pointer<Utf8> password,
...
typedef _SshListDirectoriesDart = Pointer<Utf8> Function(
  Pointer<Utf8> host,
  int port,
  Pointer<Utf8> username,
  Pointer<Utf8> password,
...
typedef _SshListDirectoryEntriesNative = Pointer<Utf8> Function(
  Pointer<Utf8> host,
  Uint16 port,
  Pointer<Utf8> username,
  Pointer<Utf8> password,
...
typedef _SshListDirectoryEntriesDart = Pointer<Utf8> Function(
  Pointer<Utf8> host,
  int port,
  Pointer<Utf8> username,
  Pointer<Utf8> password,
...
typedef _SshDetectHostOsNative = Pointer<Utf8> Function(
  Pointer<Utf8> host,
  Uint16 port,
  Pointer<Utf8> username,
  Pointer<Utf8> password,
...
typedef _SshDetectHostOsDart = Pointer<Utf8> Function(
  Pointer<Utf8> host,
  int port,
  Pointer<Utf8> username,
  Pointer<Utf8> password,
...
typedef _SshCollectSystemInfoNative = Pointer<Utf8> Function(
  Pointer<Utf8> host,
  Uint16 port,
  Pointer<Utf8> username,
  Pointer<Utf8> password,
...
typedef _SshCollectSystemInfoDart = Pointer<Utf8> Function(
  Pointer<Utf8> host,
  int port,
  Pointer<Utf8> username,
  Pointer<Utf8> password,
...
typedef _SshExportPublicKeyNative = Pointer<Utf8> Function(
  Pointer<Utf8> host,
  Uint16 port,
  Pointer<Utf8> username,
  Pointer<Utf8> password,
...
typedef _SshExportPublicKeyDart = Pointer<Utf8> Function(
  Pointer<Utf8> host,
  int port,
  Pointer<Utf8> username,
  Pointer<Utf8> password,
...
typedef _SftpListDirectoryEntriesNative = Pointer<Utf8> Function(
  Uint64 requestId,
  Pointer<Utf8> host,
  Uint16 port,
  Pointer<Utf8> username,
...
typedef _SftpListDirectoryEntriesDart = Pointer<Utf8> Function(
  int requestId,
  Pointer<Utf8> host,
  int port,
  Pointer<Utf8> username,
...
typedef _SftpExecuteTaskNative = Pointer<Utf8> Function(
  Uint64 taskId,
  Pointer<Utf8> host,
  Uint16 port,
  Pointer<Utf8> username,
...
typedef _SftpExecuteTaskDart = Pointer<Utf8> Function(
  int taskId,
  Pointer<Utf8> host,
  int port,
  Pointer<Utf8> username,
...
typedef _SftpTaskProgressCallbackNative = Void Function(
  Pointer<Void> userData,
